...
# ConvBlock - To create convolutional layer
...
# InceptionBlock - To create inception layer
class InceptionBlock(nn.Module):
  def __init__(self, in_channels, out_1x1, red_3x3, out_3x3, red_5x5, out_5x5, out_1x1pool):
    ...
    self.branch2 = nn.Sequential(
        ...
        ConvBlock(in_channels = red_3x3, out_channels = out_3x3, kernel_size = (3, 3), padding = 1), 
    )
    self.branch3 = nn.Sequential(
        ConvBlock(in_channels = in_channels, out_channels = red_5x5, kernel_size = (1, 1)),
        ConvBlock(in_channels = red_5x5, out_channels = out_5x5, kernel_size = (5, 5), padding = 2), 
    )
...
class GoogLeNet(nn.Module):
  def __init__(self, in_channels = 3):
    ...
    self.avgpool5 = nn.AvgPool2d(kernel_size = (7, 7), stride = (1, 1))
...
# Model checking
x = torch.randn(10, 3, 224, 224) # 10 images of 224x224 pixels with 3 channels
print(model(x).shape)